...
[![Cases](https://img.shields.io/badge/Cases-26-orange)](#-目錄)
...
- **2026 年 6 月 7 日：** 新增 2 個來自週末首波社群分享的案例——日系奇幻女高中生戰士提示詞，以及進階用戶向的 Ideogram 4 JSON caption generator 工作流提示詞。
## 📑 目錄
...
- [🎨 海報與插畫案例](#-海報與插畫案例)
  ...
  - [Case 8: 異世界女高中生戰士](#case-8-異世界女高中生戰士-by-fet_shizaibu)
  - [Case 9: 咖啡店版式提示詞](#case-9-咖啡店版式提示詞-by-froggyaislop)
- [🧪 比較與社群範例](#-比較與社群範例)
...
### Case 8: [異世界女高中生戰士](https://x.com/FET_SHIZAIBU/status/2063462042221310257) (by [@FET_SHIZAIBU](https://x.com/FET_SHIZAIBU))
...
> [!NOTE]
> 一條精煉好用的日文奇幻動作提示詞：學生制服結合輕甲，再配上劍盾姿態，構成乾淨的全身動作鏡頭。

---

### Case 9: [咖啡店版式提示詞](https://x.com/froggyaislop/status/2063615207797043293) (by [@froggyaislop](https://x.com/froggyaislop))
...
> [!NOTE]
> 一條緊湊的版式優先海報提示詞：層級清楚、標題文字精確、產品置中，並保留足夠留白，讓 Ideogram 4.0 的版面控制真正發揮作用。
...
> [!NOTE]
> 主貼展示的是 workflow 成果圖；完整 system prompt 發佈在作者自己的回覆裡，這裡將它保留為可重用的進階 Ideogram 4 結構化版面提示模板。
