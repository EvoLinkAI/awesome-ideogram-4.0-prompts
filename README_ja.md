...
[![Cases](https://img.shields.io/badge/Cases-26-orange)](#-目次)
...
- **2026年6月8日:** 最新の24時間キュレーションから、コミュニティ由来のポスター事例を1件追加 — コーヒーショップのレイアウトプロンプト。
...
- **2026年6月7日:** 週末最初のコミュニティ波から 2 件を追加——和風ファンタジー女子高生戦士のプロンプトと、上級者向け Ideogram 4 JSON caption generator ワークフロープロンプト。
...
- [🎨 ポスター・イラストの事例](#-ポスターイラストの事例)
  ...
  - [Case 8: 異世界女子高生戦士](#case-8-異世界女子高生戦士-by-fet_shizaibu)
...
### Case 8: [異世界女子高生戦士](https://x.com/FET_SHIZAIBU/status/2063462042221310257) (by [@FET_SHIZAIBU](https://x.com/FET_SHIZAIBU))
...
> [!NOTE]
> 学生服と軽装甲、ショートソードとラウンドシールドを組み合わせた、全身アクション構図の日本語ファンタジープロンプト。

---

### Case 9: [コーヒーショップのレイアウトプロンプト](https://x.com/froggyaislop/status/2063615207797043293) (by [@froggyaislop](https://x.com/froggyaislop))
...
> [!NOTE]
> 階層の明確さ、見出し文言の正確さ、中央配置の商品、十分な余白を押さえた、レイアウト重視のコンパクトなポスタープロンプト。Ideogram 4.0 の構図制御がきちんと効く。
...
> [!NOTE]
> メイン投稿はワークフロー結果の作例で、完全な system prompt は作者自身の返信で公開されていました。ここでは構造化レイアウト用の再利用可能な上級者テンプレートとして保存します。
