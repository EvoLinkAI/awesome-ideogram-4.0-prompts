...
[![Cases](https://img.shields.io/badge/Cases-25-orange)](#-目录)
...
欢迎来到 **Ideogram 4.0** 提示词仓库！🤗

**我们收集 Ideogram 4.0 在各类任务与创意工作流中的高质量提示词与图像示例**——字体排版与海报设计、照片级人像、产品与包装设计，以及多模型横向对比。

Ideogram 4.0 于 2026 年 6 月 3 日发布，号称**全球最强的开放权重文生图模型**（在第三方竞技场上排名开放模型第一）。它具备原生 2K 分辨率、原生背景透明、密集而精准的多语言文字渲染，以及 bounding-box 版面控制——而且你可以下载权重、自行微调并自托管。
...
<br><sub><b>实力背书：</b>Ideogram 4.0 是 <a href="https://x.com/a16z/status/2062203114472813008">DesignArena 文生图排行榜</a>上的<b>开放权重第一名</b>（Elo 1285）——仅次于 OpenAI 与 Google 的闭源模型。</sub>
</div>

本仓库的多数案例来自 X/Twitter、创作者社区与公开发布演示。

在 Evolink 上体验：[Ideogram 4.0](https://evolink.ai/models?utm_source=github&utm_medium=readme&utm_campaign=awesome-ideogram-4.0-prompts)

如果觉得有用，欢迎点个 star。⭐

> [!NOTE]
> 本仓库尚处于早期种子阶段。每个案例都展示**真实、公开分享的示例图**并附完整署名。仅当原作者公开了确切 prompt 时，案例才包含 `Prompt` 代码块——我们绝不编造或臆测 prompt，因此那些发布日仅展示成图、未公开 prompt 的案例会刻意省略 prompt，转而链接到来源。

## 📰 动态

- **June 3, 2026:** Ideogram 4.0 发布——第三方竞技场上排名第一的开放权重文生图模型，具备原生 2K、透明背景，以及可下载的开放权重。
- **June 3, 2026:** 已在多家发布合作平台上线，包括 Hugging Face、ComfyUI、fal、Runware、Magnific、Krea、Leonardo、Picsart、Cloudflare、Replicate、Gamma、Flora 和 Kittl。
- **June 4, 2026:** 首次仓库更新——11 个发布日示例案例（多图画廊），分布在各分类章节。
- **June 4, 2026:** 新增 4 个来自 RuntimeWire 的正面对比案例（含真实 prompt）——Ideogram 4.0 在玻璃水杯折射/物理测试中击败 OpenAI、Google 和 Microsoft。
- **June 4, 2026:** 再新增 8 个来自发布日 12 小时窗口的案例——其中三个带真实公开 prompt（绳索字母排版、1000× 微距排版、抽象铅笔肖像），另有五个社区/对比展示。

- **2026 年 6 月 7 日：** 新增 2 个来自周末首波社区分享的案例——日系奇幻女高中生战士提示词，以及面向高级用户的 Ideogram 4 JSON caption generator 工作流提示词。
## 📑 目录
...
- [📑 目录](#-目录)
- [📸 人像与摄影案例](#-人像与摄影案例)
  - [Case 1: 照片级纹理与自然瑕疵](#case-1-照片级纹理与自然瑕疵-by-ideogram_ai)
  - [Case 2: 逼真的人物皮肤纹理](#case-2-逼真的人物皮肤纹理-by-jerrod_lew)
- [🎨 海报与插画案例](#-海报与插画案例)
  - [Case 1: 字体排版与平面设计](#case-1-字体排版与平面设计-by-ideogram_ai)
  - [Case 2: 设计能力前沿](#case-2-设计能力前沿-by-ideogram_ai)
  - [Case 3: 绳索字母排版](#case-3-绳索字母排版-by-umesh_ai)
  - [Case 4: 1000× 微距排版压力测试](#case-4-1000-微距排版压力测试-by-squeakalgaib)
  - [Case 5: 2K 密集文字排版](#case-5-2k-密集文字排版-by-jerrod_lew)
  - [Case 6: 抽象铅笔横截面肖像](#case-6-抽象铅笔横截面肖像-by-fofrai)
  - [Case 7: 带营养标签的产品包装](#case-7-带营养标签的产品包装-by-jerrod_lew)
  - [Case 8: 异世界女高中生战士](#case-8-异世界女高中生战士-by-fet_shizaibu)
- [🧪 对比与社区示例](#-对比与社区示例)
  - [Case 1: 十款模型涂鸦对比](#case-1-十款模型涂鸦对比-by-geniart_fr)
  - [Case 2: 多语言文字渲染（捷克语）](#case-2-多语言文字渲染捷克语-by-lukasersil)
  - [Case 3: 抢先体验设计展示](#case-3-抢先体验设计展示-by-venturetwins)
  - [Case 4: 开源且惊艳](#case-4-开源且惊艳-by-a16z)
  - [Case 5: 开放图像生成的飞跃](#case-5-开放图像生成的飞跃-by-ludoviccreator)
  - [Case 6: 四格创业故事板](#case-6-四格创业故事板-by-runtimewire)
  - [Case 7: 智能手机的四代演进](#case-7-智能手机的四代演进-by-runtimewire)
  - [Case 8: Nimbus 品牌识别系统](#case-8-nimbus-品牌识别系统-by-runtimewire)
  - [Case 9: 玻璃水杯折射物理](#case-9-玻璃水杯折射物理-by-runtimewire)
  - [Case 10: 超现实主义：Ideogram 4 对比 GPT Image 2](#case-10-超现实主义ideogram-4-对比-gpt-image-2-by-jasperdevs)
  - [Case 11: 口红广告：Ideogram 4 对比 GPT Image 2](#case-11-口红广告ideogram-4-对比-gpt-image-2-by-vortex_promos)
  - [Case 12: 清晰锐利的开放权重生成](#case-12-清晰锐利的开放权重生成-by-fofrai)
  - [Case 13: 开放模型的多风格表现](#case-13-开放模型的多风格表现-by-azed_ai)
  - [Case 14: 四张开源测试生成图](#case-14-四张开源测试生成图-by-ozansihay)
  - [Case 15: Ideogram 4 JSON Caption Generator](#case-15-ideogram-4-json-caption-generator-by-photogenicweeke)
- [🙏 致谢](#-致谢)

## 📸 人像与摄影案例

### Case 1: [照片级纹理与自然瑕疵](https://x.com/ideogram_ai/status/2062202376833106365) (by [@ideogram_ai](https://x.com/ideogram_ai))
...
> [!NOTE]
> Ideogram 4.0 渲染出区分真实照片与 AI 图像的细腻纹理与自然瑕疵——全部为原生 2K。

---

### Case 2: [逼真的人物皮肤纹理](https://x.com/jerrod_lew/status/2062202782590095619) (by [@jerrod_lew](https://x.com/jerrod_lew))
...
> [!NOTE]
> 在精细人物与皮肤纹理上更进一步——是 Ideogram 模型迄今最逼真的人物表现之一。

---

## 🎨 海报与插画案例

### Case 1: [字体排版与平面设计](https://x.com/ideogram_ai/status/2062202335250764220) (by [@ideogram_ai](https://x.com/ideogram_ai))
...
> [!NOTE]
> 字体排版与平面设计仍是 4.0 最强的能力——logo、海报、多字体版式、长文本，以及真正融入设计的创意排版。

---

### Case 2: [设计能力前沿](https://x.com/ideogram_ai/status/2062202271367336383) (by [@ideogram_ai](https://x.com/ideogram_ai))
...
> [!NOTE]
> 密集而精准的文字渲染、原生 2K 分辨率、原生背景透明，以及精确的版面控制。

---

### Case 3: [绳索字母排版](https://x.com/umesh_ai/status/2062257828249915733) (by [@umesh_ai](https://x.com/umesh_ai))
...
> [!NOTE]
> 把 `[NAME]` 替换为你想用绳索拼出的词。展示 Ideogram 4.0 以单根连续物体塑造清晰字形，并带有真实的张力与阴影。

---

### Case 4: [1000× 微距排版压力测试](https://x.com/SqueakAlGaib/status/2062371783400202255) (by [@SqueakAlGaib](https://x.com/SqueakAlGaib))
...
> [!NOTE]
> 一次排版压力测试：1000× 微距下的印刷字母，可见油墨墨点、纸张纤维、半调网纹（moiré）与微小却可读的说明文字——彰显 4.0 的密集小字渲染力。
...
> [!NOTE]
> 原生 2K 生成让密集文字块保持锐利——每个字都比以往更清晰、更具细节。

---

### Case 6: [抽象铅笔横截面肖像](https://x.com/fofrAI/status/2062264139574067612) (by [@fofrAI](https://x.com/fofrAI))
...
> [!NOTE]
> 一幅以人物肖像为主题、探索横截面与流动感的抽象铅笔习作——是 Ideogram 4.0 非写实、精细插画能力的有力例证。

---

### Case 7: [带营养标签的产品包装](https://x.com/jerrod_lew/status/2062202833219568018) (by [@jerrod_lew](https://x.com/jerrod_lew))
...
> [!NOTE]
> 更强的产品图与精准的营养信息文字。可在 prompt 中附带参考图以提升一致性。

---


### Case 8: [异世界女高中生战士](https://x.com/FET_SHIZAIBU/status/2063462042221310257) (by [@FET_SHIZAIBU](https://x.com/FET_SHIZAIBU))
...
> [!NOTE]
> 一条精炼好用的日文奇幻动作提示词：学生制服加轻甲，再配剑盾姿态，构成干净的全身动作镜头。

---

## 🧪 对比与社区示例

### Case 1: [十款模型涂鸦对比](https://x.com/GenIArt_Fr/status/2062110258491691240) (by [@GenIArt_Fr](https://x.com/GenIArt_Fr))
...
> [!NOTE]
> 一次独立的横向对比：以涂鸦为主题，将 Ideogram 4.0 与 ImagineArt 2.0、Krea 2.0、Recraft v4.1、Grok、Uni-1.1、Flux2-Pro、NanoBanana 2、GPT-Image-2 和 Midjourney v8.1 同台比较。

---

### Case 2: [多语言文字渲染（捷克语）](https://x.com/lukasersil/status/2062203909465129310) (by [@lukasersil](https://x.com/lukasersil))
...
> [!NOTE]
> 一次对可读捷克语文字渲染的独立测试——对非英语排版是有力的真实信号。作者提到 prompt 很长，已放在回复中。

---

### Case 3: [抢先体验设计展示](https://x.com/venturetwins/status/2062207215961014735) (by [@venturetwins](https://x.com/venturetwins))
...
> [!NOTE]
> 抢先体验示例，重点展示强劲的文字渲染、高分辨率输出与设计质量。

---

### Case 4: [开源且惊艳](https://x.com/a16z/status/2062203114472813008) (by [@a16z](https://x.com/a16z))
...
> [!NOTE]
> 投资方对 Ideogram 4.0 作为开放、可下载模型的展示——「惊艳，而且开源」。

---

### Case 5: [开放图像生成的飞跃](https://x.com/LudovicCreator/status/2062207302690832683) (by [@LudovicCreator](https://x.com/LudovicCreator))
...
> [!NOTE]
> 一位抢先体验创作者的看法：开放权重、自托管、微调、API 访问、原生 2K、透明背景，以及更强的文字渲染。

---

### Case 6: [四格创业故事板](https://runtimewire.com/article/we-put-ideogram-4-head-to-head-against-openai-google-and-microsoft-in-four-image) (by [@runtimewire](https://x.com/runtimewire))
...
> [!NOTE]
> RuntimeWire 正面对决（OpenAI 对 Google 对 Microsoft 对 Ideogram）。讲故事测试：从车库创业到纳斯达克上市，并在各格间保持角色一致性。排名：Google > Microsoft > OpenAI > Ideogram。

---

### Case 7: [智能手机的四代演进](https://runtimewire.com/article/we-put-ideogram-4-head-to-head-against-openai-google-and-microsoft-in-four-image) (by [@runtimewire](https://x.com/runtimewire))
...
> [!NOTE]
> RuntimeWire 正面对决。产品演进测试（从 2007 到 2035 的可信演进）。排名：OpenAI > Microsoft > Google > Ideogram。

---

### Case 8: [Nimbus 品牌识别系统](https://runtimewire.com/article/we-put-ideogram-4-head-to-head-against-openai-google-and-microsoft-in-four-image) (by [@runtimewire](https://x.com/runtimewire))
...
> [!NOTE]
> RuntimeWire 正面对决。完整品牌系统测试——主/备 logo、应用图标、名片、官网首页、配色板、包装。排名：OpenAI > Google > Microsoft > Ideogram。
...
> [!NOTE]
> RuntimeWire 正面对决——Ideogram 4.0 赢下此项。物理真实感测试：水/玻璃/光/影/文字的交互。排名：Ideogram > Google > OpenAI > Microsoft。

---

### Case 10: [超现实主义：Ideogram 4 对比 GPT Image 2](https://x.com/jasperdevs/status/2062232495517552716) (by [@jasperdevs](https://x.com/jasperdevs))
...
> [!NOTE]
> 超现实主义对决——作者认为在艺术/超现实渲染上 Ideogram 4 明显强于 GPT Image v2。

---

### Case 11: [口红广告：Ideogram 4 对比 GPT Image 2](https://x.com/VORTEX_Promos/status/2062276884738490397) (by [@VORTEX_Promos](https://x.com/VORTEX_Promos))
...
> [!NOTE]
> 一次广告创意对比（口红广告），在 Ideogram v4 与 GPT Image 2 之间比较。

---

### Case 12: [清晰锐利的开放权重生成](https://x.com/fofrAI/status/2062251438990930323) (by [@fofrAI](https://x.com/fofrAI))
...
> [!NOTE]
> 开放权重展示——多种题材下清晰、新鲜的生成。

---

### Case 13: [开放模型的多风格表现](https://x.com/azed_ai/status/2062225166567149776) (by [@azed_ai](https://x.com/azed_ai))
...
> [!NOTE]
> 同一个开放模型横跨摄影、艺术、卡通与文字类设计。

---

### Case 14: [四张开源测试生成图](https://x.com/ozansihay/status/2062305930994192638) (by [@ozansihay](https://x.com/ozansihay))
...
> [!NOTE]
> 主贴展示的是 workflow 成果图；完整 system prompt 发布在作者自己的回复里，这里将其保留为可复用的高级 Ideogram 4 结构化版面提示模板。

---

## 🙏 致谢

本仓库受到优秀的开放提示词合集与社区共享示例的启发。
...
*我们无法保证每个案例都已正确归属到原始创作者。如有需要更正之处，请联系我们，我们会及时更新。*

如果你有更多有趣的提示词案例想分享，欢迎联系我们，一起扩充 Evolink 提示词库。
