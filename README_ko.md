...
**Ideogram 4.0** 프롬프트 저장소에 오신 것을 환영합니다! 🤗

**우리는 다양한 작업과 창작 워크플로 전반에 걸쳐 Ideogram 4.0의 고품질 프롬프트와 예시 이미지를 수집합니다** — 타이포그래피와 포스터 디자인, 사실적인 인물 사진, 제품 및 패키지 디자인, 그리고 모델 간 직접 비교.

Ideogram 4.0은 2026년 6월 3일 **세계 최고의 오픈 웨이트 텍스트-이미지 모델**로 출시되었습니다 (서드파티 아레나에서 오픈 모델 1위). 네이티브 2K 해상도, 네이티브 배경 투명도, 조밀하고 정확한 다국어 텍스트 렌더링, bounding-box 레이아웃 제어를 제공하며, 가중치를 다운로드해 파인튜닝하고 셀프 호스팅할 수 있습니다.
...
<br><sub><b>입증:</b> Ideogram 4.0은 <a href="https://x.com/a16z/status/2062203114472813008">DesignArena 텍스트-이미지 순위표</a>에서 <b>오픈 웨이트 1위</b> 모델입니다 (Elo 1285) — OpenAI와 Google의 폐쇄형 모델에만 뒤집니다.</sub>
</div>

이 저장소의 대부분 사례는 X/Twitter, 크리에이터 커뮤니티, 공개 출시 데모에서 선별되었습니다.

Evolink에서 사용해 보기: [Ideogram 4.0](https://evolink.ai/models?utm_source=github&utm_medium=readme&utm_campaign=awesome-ideogram-4.0-prompts)

유용하셨다면 별을 눌러 주세요. ⭐

> [!NOTE]
> 이 저장소는 초기 시드 단계입니다. 각 사례는 완전한 출처 표기와 함께 **실제로 공개 공유된 예시 이미지**를 보여줍니다. 사례는 **원작자가 정확한 프롬프트를 공개한 경우에만** `Prompt` 블록을 포함합니다 — 우리는 프롬프트를 지어내거나 추측하지 않으므로, 결과만 공유된 출시 당일 사례는 프롬프트를 의도적으로 생략하고 대신 출처로 링크합니다.

## 📰 소식

- **June 3, 2026:** Ideogram 4.0 출시 — 서드파티 아레나에서 1위인 오픈 웨이트 텍스트-이미지 모델. 네이티브 2K, 투명 배경, 다운로드 가능한 오픈 웨이트를 갖췄습니다.
- **June 3, 2026:** Hugging Face, ComfyUI, fal, Runware, Magnific, Krea, Leonardo, Picsart, Cloudflare, Replicate, Gamma, Flora, Kittl 등 출시 파트너 플랫폼에서 이용 가능.
- **June 4, 2026:** 첫 저장소 업데이트 — 카테고리 섹션에 출시 당일 11개 예시 (다중 이미지 갤러리).
- **June 4, 2026:** RuntimeWire의 정면 비교 사례 4건 추가 (실제 프롬프트 포함) — Ideogram 4.0이 물잔 굴절/물리 테스트에서 OpenAI, Google, Microsoft를 이김.
- **June 4, 2026:** 출시 당일 12시간 윈도우에서 8개 사례 추가 — 그중 셋은 실제 공개된 프롬프트 포함 (밧줄 글자 타이포그래피, 1000× 매크로 타이포그래피, 추상적 연필 인물화), 다섯은 커뮤니티/비교 쇼케이스.

- **2026년 6월 7일:** 주말 첫 커뮤니티 파동에서 2개 사례를 추가했습니다 — 일본어 판타지 여고생 전사 프롬프트와 파워유저용 Ideogram 4 JSON caption generator 워크플로 프롬프트입니다.
## 📑 목차
...
- [📸 인물 및 사진 사례](#-인물-및-사진-사례)
  - [Case 1: 사실적인 질감과 자연스러운 결점](#case-1-사실적인-질감과-자연스러운-결점-by-ideogram_ai)
  - [Case 2: 사실적인 캐릭터 피부 질감](#case-2-사실적인-캐릭터-피부-질감-by-jerrod_lew)
- [🎨 포스터 및 일러스트 사례](#-포스터-및-일러스트-사례)
  - [Case 1: 타이포그래피와 그래픽 디자인](#case-1-타이포그래피와-그래픽-디자인-by-ideogram_ai)
  - [Case 2: 디자인의 최전선](#case-2-디자인의-최전선-by-ideogram_ai)
  - [Case 3: 밧줄 글자 타이포그래피](#case-3-밧줄-글자-타이포그래피-by-umesh_ai)
  - [Case 4: 1000× 매크로 타이포그래피 스트레스 테스트](#case-4-1000-매크로-타이포그래피-스트레스-테스트-by-squeakalgaib)
  - [Case 5: 2K 고밀도 텍스트 블록](#case-5-2k-고밀도-텍스트-블록-by-jerrod_lew)
...
- [🧪 비교 및 커뮤니티 예시](#-비교-및-커뮤니티-예시)
  ...
  - [Case 3: 얼리 액세스 디자인 쇼케이스](#case-3-얼리-액세스-디자인-쇼케이스-by-venturetwins)
  - [Case 4: 오픈, 그리고 놀라움](#case-4-오픈-그리고-놀라움-by-a16z)
  - [Case 5: 오픈 이미지 생성의 도약](#case-5-오픈-이미지-생성의-도약-by-ludoviccreator)
  - [Case 6: 4컷 스타트업 스토리보드](#case-6-4컷-스타트업-스토리보드-by-runtimewire)
  - [Case 7: 스마트폰의 네 세대 진화](#case-7-스마트폰의-네-세대-진화-by-runtimewire)
  - [Case 8: Nimbus 브랜드 아이덴티티 시스템](#case-8-nimbus-브랜드-아이덴티티-시스템-by-runtimewire)
  - [Case 9: 물잔의 굴절 물리](#case-9-물잔의-굴절-물리-by-runtimewire)
  - [Case 10: 초현실주의: Ideogram 4 vs GPT Image 2](#case-10-초현실주의-ideogram-4-vs-gpt-image-2-by-jasperdevs)
  - [Case 11: 립스틱 광고: Ideogram 4 vs GPT Image 2](#case-11-립스틱-광고-ideogram-4-vs-gpt-image-2-by-vortex_promos)
  - [Case 12: 선명한 오픈 웨이트 생성](#case-12-선명한-오픈-웨이트-생성-by-fofrai)
  - [Case 13: 다양한 비주얼 스타일을 아우르는 오픈 모델](#case-13-다양한-비주얼-스타일을-아우르는-오픈-모델-by-azed_ai)
  - [Case 14: 네 장의 오픈소스 테스트 생성](#case-14-네-장의-오픈소스-테스트-생성-by-ozansihay)
  - [Case 15: Ideogram 4 JSON Caption Generator](#case-15-ideogram-4-json-caption-generator-by-photogenicweeke)
- [🙏 감사의 글](#-감사의-글)

## 📸 인물 및 사진 사례

### Case 1: [사실적인 질감과 자연스러운 결점](https://x.com/ideogram_ai/status/2062202376833106365) (by [@ideogram_ai](https://x.com/ideogram_ai))
...
> [!NOTE]
> Ideogram 4.0은 실제 사진과 AI 이미지를 구분 짓는 섬세한 질감과 자연스러운 결점을 렌더링합니다 — 모두 네이티브 2K로.

---

### Case 2: [사실적인 캐릭터 피부 질감](https://x.com/jerrod_lew/status/2062202782590095619) (by [@jerrod_lew](https://x.com/jerrod_lew))
...
> [!NOTE]
> 정교한 인물과 피부 질감에서의 진전 — Ideogram 모델이 지금까지 만든 가장 사실적인 인물 중 하나.

---

## 🎨 포스터 및 일러스트 사례

### Case 1: [타이포그래피와 그래픽 디자인](https://x.com/ideogram_ai/status/2062202335250764220) (by [@ideogram_ai](https://x.com/ideogram_ai))
...
> [!NOTE]
> 타이포그래피와 그래픽 디자인은 여전히 4.0의 가장 강력한 능력입니다 — 로고, 포스터, 다중 폰트 레이아웃, 긴 텍스트, 그리고 디자인에 녹아든 창의적 타이포그래피.

---

### Case 2: [디자인의 최전선](https://x.com/ideogram_ai/status/2062202271367336383) (by [@ideogram_ai](https://x.com/ideogram_ai))
...
> [!NOTE]
> 조밀하고 정확한 텍스트 렌더링, 네이티브 2K 해상도, 네이티브 배경 투명도, 그리고 정밀한 레이아웃 제어.

---

### Case 3: [밧줄 글자 타이포그래피](https://x.com/umesh_ai/status/2062257828249915733) (by [@umesh_ai](https://x.com/umesh_ai))
...
> [!NOTE]
> `[NAME]`을 밧줄로 만들고 싶은 단어로 바꾸세요. Ideogram 4.0이 하나의 연속된 물체로부터 사실적인 장력과 그림자를 지닌 읽기 쉬운 글자 형태를 빚어내는 모습을 보여줍니다.

---

### Case 4: [1000× 매크로 타이포그래피 스트레스 테스트](https://x.com/SqueakAlGaib/status/2062371783400202255) (by [@SqueakAlGaib](https://x.com/SqueakAlGaib))
...
> [!NOTE]
> 타이포그래피 스트레스 테스트: 인쇄된 글자의 1000× 매크로로 잉크 방울, 종이 섬유, 하프톤 무아레, 그리고 아주 작지만 읽을 수 있는 캡션 텍스트를 보여줍니다 — 4.0의 조밀한 소형 텍스트 렌더링을 보여주는 사례.

---

### Case 5: [2K 고밀도 텍스트 블록](https://x.com/jerrod_lew/status/2062202754689552763) (by [@jerrod_lew](https://x.com/jerrod_lew))
...
> [!NOTE]
> 네이티브 2K 생성은 조밀한 텍스트 블록을 선명하게 유지합니다 — 모든 단어가 이전보다 더 또렷하고 정교합니다.

---

### Case 6: [추상적 연필 단면 인물화](https://x.com/fofrAI/status/2062264139574067612) (by [@fofrAI](https://x.com/fofrAI))
...
> [!NOTE]
> 인물화에서 단면과 유동성을 탐구한 추상적 연필 습작 — Ideogram 4.0의 비사진적이고 정교한 일러스트 능력의 좋은 예.

---

### Case 7: [영양 성분표가 있는 제품 패키지](https://x.com/jerrod_lew/status/2062202833219568018) (by [@jerrod_lew](https://x.com/jerrod_lew))
...
> [!NOTE]
> 정확한 영양 정보 텍스트가 담긴 더 강력한 제품 이미지. 일관성을 위해 프롬프트와 함께 참조 이미지를 제공할 수 있습니다.

---


### Case 8: [이세계 여고생 전사](https://x.com/FET_SHIZAIBU/status/2063462042221310257) (by [@FET_SHIZAIBU](https://x.com/FET_SHIZAIBU))
...
### Case 1: [10개 모델 그래피티 비교](https://x.com/GenIArt_Fr/status/2062110258491691240) (by [@GenIArt_Fr](https://x.com/GenIArt_Fr))
...
> [!NOTE]
> 그래피티를 주제로 Ideogram 4.0을 ImagineArt 2.0, Krea 2.0, Recraft v4.1, Grok, Uni-1.1, Flux2-Pro, NanoBanana 2, GPT-Image-2, Midjourney v8.1과 나란히 비교한 독립 평가.

---

### Case 2: [다국어 텍스트 렌더링 (체코어)](https://x.com/lukasersil/status/2062203909465129310) (by [@lukasersil](https://x.com/lukasersil))
...
> [!NOTE]
> 읽기 쉬운 체코어 텍스트 렌더링에 대한 독립 테스트 — 비영어 타이포그래피에 강력한 실사용 신호. 작성자는 프롬프트가 길어 답글에 올렸다고 밝혔습니다.

---

### Case 3: [얼리 액세스 디자인 쇼케이스](https://x.com/venturetwins/status/2062207215961014735) (by [@venturetwins](https://x.com/venturetwins))
...
> [!NOTE]
> 강력한 텍스트 렌더링, 고해상도 출력, 디자인 품질을 강조하는 얼리 액세스 예시.

---

### Case 4: [오픈, 그리고 놀라움](https://x.com/a16z/status/2062203114472813008) (by [@a16z](https://x.com/a16z))
...
> [!NOTE]
> Ideogram 4.0을 오픈이자 다운로드 가능한 모델로 소개하는 투자자 쇼케이스 — 「놀랍고, 게다가 오픈이다」.

---

### Case 5: [오픈 이미지 생성의 도약](https://x.com/LudovicCreator/status/2062207302690832683) (by [@LudovicCreator](https://x.com/LudovicCreator))
...
> [!NOTE]
> 얼리 액세스 크리에이터의 견해: 오픈 웨이트, 셀프 호스팅, 파인튜닝, API 접근, 네이티브 2K, 투명 배경, 그리고 더 강력한 텍스트 렌더링.

---

### Case 6: [4컷 스타트업 스토리보드](https://runtimewire.com/article/we-put-ideogram-4-head-to-head-against-openai-google-and-microsoft-in-four-image) (by [@runtimewire](https://x.com/runtimewire))
...
> [!NOTE]
> RuntimeWire 정면 대결 (OpenAI vs Google vs Microsoft vs Ideogram). 차고 스타트업에서 나스닥 상장까지를 컷 간 캐릭터 일관성을 유지하며 그리는 스토리텔링 테스트. 순위: Google > Microsoft > OpenAI > Ideogram.

---

### Case 7: [스마트폰의 네 세대 진화](https://runtimewire.com/article/we-put-ideogram-4-head-to-head-against-openai-google-and-microsoft-in-four-image) (by [@runtimewire](https://x.com/runtimewire))
...
> [!NOTE]
> RuntimeWire 정면 대결. 제품 진화 테스트 (2007년부터 2035년까지의 설득력 있는 발전). 순위: OpenAI > Microsoft > Google > Ideogram.

---

### Case 8: [Nimbus 브랜드 아이덴티티 시스템](https://runtimewire.com/article/we-put-ideogram-4-head-to-head-against-openai-google-and-microsoft-in-four-image) (by [@runtimewire](https://x.com/runtimewire))
...
> [!NOTE]
> RuntimeWire 정면 대결. 완전한 브랜드 시스템 테스트 — 메인/대체 로고, 앱 아이콘, 명함, 웹사이트 홈페이지, 컬러 팔레트, 패키지. 순위: OpenAI > Google > Microsoft > Ideogram.

---

### Case 9: [물잔의 굴절 물리](https://runtimewire.com/article/we-put-ideogram-4-head-to-head-against-openai-google-and-microsoft-in-four-image) (by [@runtimewire](https://x.com/runtimewire))
...
> [!NOTE]
> RuntimeWire 정면 대결 — 이 테스트는 Ideogram 4.0이 승리. 물/유리/빛/그림자/텍스트 상호작용의 물리적 사실성 테스트. 순위: Ideogram > Google > OpenAI > Microsoft.

---

### Case 10: [초현실주의: Ideogram 4 vs GPT Image 2](https://x.com/jasperdevs/status/2062232495517552716) (by [@jasperdevs](https://x.com/jasperdevs))
...
> [!NOTE]
> 초현실주의 대결 — 작성자는 예술적/초현실적 렌더링에서 Ideogram 4가 GPT Image v2보다 확연히 강하다고 평가했습니다.

---

### Case 11: [립스틱 광고: Ideogram 4 vs GPT Image 2](https://x.com/VORTEX_Promos/status/2062276884738490397) (by [@VORTEX_Promos](https://x.com/VORTEX_Promos))
...
> [!NOTE]
> Ideogram v4와 GPT Image 2 간의 광고 콘셉트 비교 (립스틱 캠페인).

---

### Case 12: [선명한 오픈 웨이트 생성](https://x.com/fofrAI/status/2062251438990930323) (by [@fofrAI](https://x.com/fofrAI))
...
> [!NOTE]
> 오픈 웨이트 쇼케이스 — 다양한 주제에 걸친 선명하고 신선한 생성.

---

### Case 13: [다양한 비주얼 스타일을 아우르는 오픈 모델](https://x.com/azed_ai/status/2062225166567149776) (by [@azed_ai](https://x.com/azed_ai))
...
> [!NOTE]
> 하나의 오픈 모델로 사진, 아트, 만화, 텍스트 기반 디자인을 아우름.

---

### Case 14: [네 장의 오픈소스 테스트 생성](https://x.com/ozansihay/status/2062305930994192638) (by [@ozansihay](https://x.com/ozansihay))
...
> [!NOTE]
> 막 오픈소스화된 Ideogram 4.0에 대한 커뮤니티의 네 장의 테스트 생성.
...
> [!NOTE]
> 메인 포스트는 워크플로 결과물을 보여주고, 전체 system prompt는 작성자 본인 답글에 공개되었습니다. 여기서는 구조화된 Ideogram 4 레이아웃 프롬프트용 재사용 가능한 파워유저 템플릿으로 보존합니다.

---

## 🙏 감사의 글

이 저장소는 훌륭한 오픈 프롬프트 모음과 커뮤니티가 공유한 예시에서 영감을 받았습니다.

작업을 공개적으로 공유하여 이 사례 연구를 가능하게 해 준 크리에이터와 기여자분들께 감사드립니다.
...
*모든 사례가 원작자에게 올바르게 귀속되었다고 보장할 수는 없습니다. 수정이 필요한 부분이 있으면 연락 주시면 업데이트하겠습니다.*

공유하고 싶은 흥미로운 프롬프트 사례가 더 있다면 언제든 연락 주시고, Evolink 프롬프트 라이브러리 확장에 함께해 주세요.
